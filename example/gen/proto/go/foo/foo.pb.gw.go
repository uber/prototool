...
func request_HelloService_Bar_0(ctx context.Context, marshaler runtime.Marshaler, client HelloServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterHelloServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HelloServiceClient) error {
	...
	mux.Handle("GET", pattern_HelloService_Bar_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_HelloService_Bar_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_HelloService_Bar_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_HelloService_Bar_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"bar", "id"}, ""))
)

var (
	forward_HelloService_Bar_0 = runtime.ForwardResponseMessage
)
