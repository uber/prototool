...
func (*ExclamationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_excited_api_8b5fc48b4bc40e88, []int{0}
}
...
func (*ExclamationResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_excited_api_8b5fc48b4bc40e88, []int{1}
}
...
func init() {
	proto.RegisterFile("uber/foo/v1/excited_api.proto", fileDescriptor_excited_api_8b5fc48b4bc40e88)
}

var fileDescriptor_excited_api_8b5fc48b4bc40e88 = []byte{
