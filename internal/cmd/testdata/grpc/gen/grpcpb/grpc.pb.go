...
func (*ExclamationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_cea5b4fc11e7bb0a, []int{0}
}
...
func (*ExclamationResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_grpc_cea5b4fc11e7bb0a, []int{1}
}
...
func init() { proto.RegisterFile("grpc.proto", fileDescriptor_grpc_cea5b4fc11e7bb0a) }

var fileDescriptor_grpc_cea5b4fc11e7bb0a = []byte{
